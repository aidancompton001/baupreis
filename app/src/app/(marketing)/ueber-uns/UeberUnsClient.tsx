  ...
  const sections = [
    {
      ...
      icon: (
        <svg className="w-8 h-8 text-brand-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
      ),
    },
    {
    ...
    },
    {
      ...
      text: "",
      icon: (
        <svg className="w-8 h-8 text-brand-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
      ),
      isContact: true,
    },
  ];
            ...
            >
              ...
              {s.isContact ? (
                <p className="text-gray-600 leading-relaxed">
                  ...
                  <a href="mailto:kontakt@baupreis.ai" className="text-brand-600 font-medium hover:underline">
                    kontakt@baupreis.ai
                  </a>
                </p>
              ) : (
