    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="animate-on-scroll anim-delay-1 bg-white rounded-none p-12 border border-gray-100 shadow-sm text-center">
            <div className="mb-6 inline-flex items-center justify-center w-16 h-16 rounded-none bg-brand-50">
