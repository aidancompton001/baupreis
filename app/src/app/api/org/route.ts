...
export async function POST(req: NextRequest) {
  try {
    ...
    const userResult = await pool.query(
      `SELECT u.*, o.id as org_id, o.stripe_customer_id
    ...
    // Handle billing portal session for existing subscribers
    ...
    const priceEnvKey = `STRIPE_PRICE_${plan.toUpperCase()}_${billingPeriod.toUpperCase()}`;
