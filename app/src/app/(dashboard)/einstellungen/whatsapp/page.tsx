      ...
      <div>
        ...
        <div className="bg-white rounded-none border border-gray-200 p-6 hover:shadow-md transition-all duration-300">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <p className="font-semibold text-[#1A1A1A]">{t("whatsapp.connected.status")}</p>
      ...
      <div className="bg-white rounded-none border border-gray-200 p-6 hover:shadow-md transition-all duration-300">
          ...
          <>
            ...
            <div className="flex gap-3">
              <input
                ...
                maxLength={6}
                className="w-32 rounded-none border border-gray-300 px-3 py-2 text-sm text-center tracking-widest font-mono focus:outline-none focus:ring-2 focus:ring-brand-500"
              />
              <button
        ...
        {step === "connected" && (
          <div className="text-center py-4">
            ...
            <p className="font-semibold text-[#1A1A1A] mt-3">
